...
export default function Signup({ onToggleForm }) {
    ...
    const handleSignUp = async (e) => {
        ...
        if (!isRegistering) {
            ...
            try {
                // Pass username, email, and password to doCreateUserWithEmailAndPassword
    ...
    return (
        <div className={classes.login__menu}>
            ...
            <button onClick={handleSignUp} className={classes.sign_in__btn}>Sign up</button>
            <Link className={classes.sign_in_text} to='/signin'>
                Already have an account?{' '}
                <span className={classes.sign_in_link}>Sign in</span>
            </Link>
        </div>
    );
}
